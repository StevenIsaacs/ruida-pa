...
Each of these methods append themselves to the `self.gluescript` attribute and the corresponding generated script to the `self.rpascript` attribute.
...
```
# Job: {label}
# Generated by: GlueScript {self.version}
